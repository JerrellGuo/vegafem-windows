...
/*
!  Content:
!      Intel(R) Math Kernel Library (MKL) stdcall interface for BLAS routines
!******************************************************************************/
...
void __stdcall XERBLA(const char *srname, int srname_len, const int *info, const int lsrname);
int __stdcall LSAME(const char *ca, int ca_len, const char *cb, int cb_len, const MKL_INT lca, const MKL_INT lcb);
