...
//  Task constructors
*/
_Mkl_Api(int,vsldSSNewTask,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , double [], double [], MKL_INT []))
_mkl_api(int,vsldssnewtask,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , double [], double [], MKL_INT []))
_MKL_API(int,VSLDSSNEWTASK,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , double [], double [], MKL_INT []))

_Mkl_Api(int,vslsSSNewTask,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , float  [], float  [], MKL_INT []))
_mkl_api(int,vslsssnewtask,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , float  [], float  [], MKL_INT []))
_MKL_API(int,VSLSSSNEWTASK,(VSLSSTaskPtr* , MKL_INT* , MKL_INT* , MKL_INT* , float  [], float  [], MKL_INT []))
